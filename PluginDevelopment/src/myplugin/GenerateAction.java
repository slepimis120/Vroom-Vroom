...
class GenerateAction extends MDAction{
	...
	public void actionPerformed(ActionEvent evt) {
		...
		ModelAnalyzer analyzer = new ModelAnalyzer(root, "transport");	
		
		try {
			analyzer.prepareModel();	
			GeneratorOptions go = ProjectOptions.getProjectOptions().getGeneratorOptions().get("TransportGenerator");			
			TransportGenerator generator = new TransportGenerator(go);
			generator.generate();
